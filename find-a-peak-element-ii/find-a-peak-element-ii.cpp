...
public:
    vector<int> findPeakGrid(vector<vector<int>>& mat) {
        ...
        while (left < right) {
            ...
            if (mid.second - 1 >= 0 && mat[mid.first][mid.second] < mat[mid.first][mid.second - 1]) {
                right = mid.second;
            } else if (mid.second + 1 < mat[mid.first].size() && mat[mid.first][mid.second] < mat[mid.first][mid.second + 1]) {
                left = mid.second + 1;
            } else {
